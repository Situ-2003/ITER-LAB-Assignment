...
public class A05 {
    public static void main(String[] args) {
        ...
        Book book1 = new Book(101, "Java", "elbert", 5);
        Book book2 = new Book(102, "Python", "Rout", 4);
...
/*
  ...
  Library Books:
  ID: 1, Book [id=101, name=Java, author=elbert, quantity=5]
  ID: 2, Book [id=102, name=Python, author=Rout, quantity=4]
  The book 'Java' is present in the library.
